    ...
    "paths": {
        ...
        "/api/pixez/login-callback": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Callback authorization code and code verifier",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pixez.loginCallbackRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/model.PixezPixivUserSafeDTO"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/pixez.addUserRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/mirror/pximg/{path}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Image quality: low, medium, high, or origin. Defaults to origin.",
                        "name": "quality",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "404": {
                        "description": "Mirror file not found",
                        "schema": {
                            "type": "object"
                        }
                    }
